export class TypeMapper {
  ...
  //  * 매개함수 mapper 의 반환타입으로 매핑 된 새로운 객체가 반환된다.
  ...
  //  */
  static mapProps<T, Prev, Next, Deep extends boolean>(
    o: T,
...
export type PropsMapping<T, Prev, Next, Recursive extends boolean = false> = {
